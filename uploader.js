class Uploader {
  ...
  constructor({file, submissionid, onProgress}) {
    this.file = file;
  ...
  async getUploadedBytes() {
    let response = await fetch('status', {
      headers: {
        ...
        'X-Submission-Id': this.submissionid
      }
    });
  ...
  async upload() {
    ...
    // send submission id, to identify the unique folder for this file
    xhr.setRequestHeader('X-Submission-Id', this.submissionid);
